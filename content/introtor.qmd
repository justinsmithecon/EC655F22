...
Below is a tutorial you can use to learn the very basics of R. It does not cover everything, but enough so that we can do most of the things we need for this class. If you prefer you can instead <a href=" http://18.119.161.195:3838/EC655learnr/" target="_blank">pop them out in a new window</a>

<div>

```{=html}
<p align="center"><iframe height="500" width="100%" frameborder="no" src="http://18.119.161.195:3838/EC655learnr/"> </iframe></p>
```
