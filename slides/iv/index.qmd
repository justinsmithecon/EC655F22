...
$$y =  \beta_{0} + x_{1}\beta_{1} +...+ x_{k-1}\beta_{k-1} + x_{k}\beta_{k}  + e$$ 
...
$$= \beta_{1} + \frac{\sigma_{e}}{\sigma_{x_{1}}}\frac{corr(z_{1},e)}{corr(z_{1},x_{1})}$$
...
$$\text{plim }\hat{\beta}_{1} =  \beta_{1} + \frac{\sigma_{u}}{\sigma_{x_{1}}}\frac{corr(z_{1},e)}{corr(z_{1},x_{1})}$$
...
-   Continued\...
    ...
    -   Also note that the plim of the OLS estimator is
        ...
        $$\text{plim }\hat{\beta}_{1}^{ols} =  \beta_{1} + \frac{\sigma_{u}}{\sigma_{x_{1}}}corr(x_{1},e)$$
