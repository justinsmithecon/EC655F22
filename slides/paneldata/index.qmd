...
$$y_{it} - \bar{y}_{i} = (\mathbf{x_{it}} - \mathbf{\bar{x}_{i}})\boldsymbol{\beta}   + u_{it} - \bar{u}_{i}$$ 
$$y_{it}^{*} = \mathbf{x_{it}}^{*}\boldsymbol{\beta}   + u_{it}^{*}$$
...
$$y_{it} -  y_{it-1} =  \mathbf{(x_{it} -x_{it-1}) }\boldsymbol{\beta} +a_{i}-a_{i} + u_{it} -u_{it-1}$$ 
$$\Delta y_{it}=  \mathbf{(\Delta x_{it}  ) }\boldsymbol{\beta}   + \Delta u_{it}$$
